...
var computeUnion = function computeUnion(a1, a2) {
  ...
  if (range[0] < arry[0] && range[1] > arry[arry.length - 1]) {
    union.concat(_toConsumableArray(new Array(arry[0] - range[0] + 1)).map(function (ele, i) {
      return i + range[0];
    }), _toConsumableArray(new Array(range[1] - arry[arry.length - 1] + 1)).map(function (ele, i) {
...
//# sourceMappingURL=index.js.9f8caee062e810c0feb8.hot-update.js.map